...
describe('LessonNavigation', () => {
  ...
  describe('Progress Indicator', () => {
    it('should display correct progress for first lesson', () => {
      render(
        <LessonNavigation currentLessonId={1} lessons={mockLessons} />
      )
    ...
    it('should display correct progress for middle lesson', () => {
      render(
        <LessonNavigation currentLessonId={3} lessons={mockLessons} />
      )
    ...
    it('should display correct progress for last lesson', () => {
      render(
        <LessonNavigation currentLessonId={5} lessons={mockLessons} />
      )
  ...
  describe('Next Lesson Button', () => {
    it('should display next lesson link when not on last lesson', () => {
      render(
        <LessonNavigation currentLessonId={2} lessons={mockLessons} />
      )
  ...
  describe('Edge Cases', () => {
    it('should handle single lesson (no prev/next)', () => {
      ...
      render(
        <LessonNavigation currentLessonId={1} lessons={singleLesson} />
      )
    ...
    it('should handle two lessons - first lesson', () => {
      ...
      render(<LessonNavigation currentLessonId={1} lessons={twoLessons} />)
    ...
    it('should handle two lessons - last lesson', () => {
      ...
      render(<LessonNavigation currentLessonId={2} lessons={twoLessons} />)
    ...
    it('should handle very long lesson titles with truncation', () => {
      ...
      render(
        <LessonNavigation currentLessonId={2} lessons={longTitleLessons} />
      )
    ...
    it('should handle lesson IDs that are not sequential', () => {
      ...
      render(
        <LessonNavigation currentLessonId={25} lessons={nonSequentialLessons} />
      )
    ...
    it('should calculate progress correctly with large lesson count', () => {
      ...
      render(
        <LessonNavigation currentLessonId={50} lessons={manyLessons} />
      )
  ...
  describe('Current Lesson Not Found', () => {
    it('should handle current lesson ID not in list', () => {
      render(
        <LessonNavigation currentLessonId={999} lessons={mockLessons} />
      )
