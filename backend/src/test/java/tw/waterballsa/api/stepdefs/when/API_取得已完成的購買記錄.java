...
public class API_取得已完成的購買記錄 {
    ...
    private static final Set<String> QUERY_PARAMS = Set.of("page", "size");
    private static final Set<String> HEADER_PARAMS = Set.of();

    @When("\\(UID={string}) 取得已完成的購買記錄, call table:")
    public void invoke(String actorId, DataTable dataTable) throws Exception {
        ...
        String url = "/purchases/completed";
