        ...
        for (Map<String, String> row : rows) {
            ...
            if (row.containsKey("userId")) {
                ...
                if (resolved != null) {
                    ...
                    long actualLong = (v instanceof Number) ? ((Number) v).longValue()
                            : Long.parseLong(String.valueOf(v));
                    long expectedLong = Long.parseLong(resolved.toString());
                    assertEquals(expectedLong, actualLong, "Purchase.userId should match");
                }
            }
            ...
            if (row.containsKey("curriculumId")) {
                ...
                if (resolved != null) {
                    ...
                    long actualLong = (v instanceof Number) ? ((Number) v).longValue()
                            : Long.parseLong(String.valueOf(v));
                    long expectedLong = Long.parseLong(resolved.toString());
                    assertEquals(expectedLong, actualLong, "Purchase.curriculumId should match");
                }
            }
