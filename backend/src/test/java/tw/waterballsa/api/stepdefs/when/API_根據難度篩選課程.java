...
public class API_根據難度篩選課程 {
    ...
    public void invoke(DataTable dataTable) throws Exception {
        ...
        String url = "/curriculums/difficulty/{level}";
