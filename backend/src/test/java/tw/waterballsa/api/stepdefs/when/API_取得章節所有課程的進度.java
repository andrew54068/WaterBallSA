...
public class API_取得章節所有課程的進度 {
    ...
    public void invoke(String actorId, DataTable dataTable) throws Exception {
        ...
        String url = "/lessons/chapters/{chapterId}/progress";
