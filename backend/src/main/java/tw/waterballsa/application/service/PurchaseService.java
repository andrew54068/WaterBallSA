...
public class PurchaseService {
        ...
        public OrderPreviewResponse getOrderPreview(Integer userId, Integer curriculumId) {
                ...
                List<OrderPreviewResponse.ChapterInfo> chapterInfos = curriculum.getChapters().stream()
                                .map(chapter -> OrderPreviewResponse.ChapterInfo.builder()
                                                .id(chapter.getId().intValue())
                                                .title(chapter.getTitle())
                                                .lessons(chapter.getLessons().stream()
                                                                .map(lesson -> OrderPreviewResponse.LessonInfo.builder()
        ...
        public PurchaseResponse createPurchase(Integer userId, CreatePurchaseRequest request) {
                ...
                boolean alreadyOwned = purchaseRepository.existsByUserIdAndCurriculumIdAndStatus(
                                userId.longValue(), request.getCurriculumId().longValue(),
        ...
        @Transactional(readOnly = true)
        public PaginatedPurchasesResponse getMyPurchases(Integer userId, int page, int size, String sortBy,
                        String direction) {
